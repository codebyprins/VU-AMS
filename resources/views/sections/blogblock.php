    ...
    <?php if (have_posts()): ?>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
        ...
        <?php while (have_posts()):
          ...
          <article
            class="group flex flex-col overflow-hidden rounded-base border border-slate-200 bg-white transition-all duration-300 hover:-translate-y-1 hover:border-primary hover:shadow-lg">

            <a href="<?php echo esc_url($permalink); ?>" class="block aspect-[16/10] overflow-hidden bg-[#F8F8F8]"
